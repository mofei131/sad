<template>
	<div class="box">
		<div class="exifBox">
			<div class="exinTitle">服务机构认证</div>
			<div class="abCon"></div>
			<div class="exifForm">
				<div class="exifLi">
				...
				<div class="exifLi2">
					<div class="exifHead" style="padding-top: 8px;"><div class="tc">*</div><div class="lc">服务领域</div></div>
		...
		methods: {
			...
			putCompanyAut(){
				...
				this.$apiFun.serviceAut({
					...
					email:this.email,
					service_ids:JSON.stringify(taglist).replace(/\[|]/g, '')
				}).then((res) => {
					if(res.code == 200){
