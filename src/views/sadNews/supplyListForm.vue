<template>
	<div class="box">
		<div class="stay">您现在所在位置:供需信息><span>发布供应</span></div>
		<div class="formBox">
			<div class="formTitle">发布供应</div>
			<div class="demandTitleBox">
				<div class="surn"><span>*</span>供应标题</div>
				<input type="text" placeholder="请输入供应标题" />
			</div>
			<div class="transverse"></div>
			<div class="addImgBox">
				<div class="surn"><span>*</span>产品主图</div>
				<div class="upLoadBox">
				<el-upload
						class="uploadImgBox"
			...
			<div class="textareaBox">
				...
				<textarea placeholder="请输入供应详情"></textarea>
			</div>
			<div class="fbBtn">发布供应</div>
		</div>
	</div>
</template>
